src_train_path='/media/hticdeep/drive3/Balamurali/Glaucoma/PretrainDataSets/Combined_RimOne_Origa'
src_val_path='/media/hticdeep/drive3/Balamurali/Glaucoma/Refuge'
src_save_path='/media/hticdeep/Balamurali/Glaucoma_models'
cuda_no=0
no_classes=2
is_pretrained=1
